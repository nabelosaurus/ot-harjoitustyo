...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortille_ei_voi_lataa_negatiivista_summaa(self):
        self.kortti.lataa_rahaa(-50)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_voi_syoda_edullisesti_kun_saldo_tasmalleen_edullisen_verran(self):
        self.kortti.arvo = 2.5
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_voi_syoda_maukkaasti_kun_saldo_tasmalleen_maukkaan_verran(self):
        self.kortti.arvo = 4
        self.kortti.syo_maukkaasti()
